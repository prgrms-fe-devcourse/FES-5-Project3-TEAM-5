...
const faqData: FAQItem[] = [
  {
    ...
    answer:
      '또모는 귀여운 모모와 함께하는 우리만의 특별한 가계부예요! 함께 사는 구성원들과 지출을 관리하고, 중요한 결정은 투표로 함께 결정할 수 있답니다. 모모가 여러분의 현명한 소비를 도와드릴게요! 💰'
  },
  {
  ...
  },
  {
    ...
    answer:
      '설정 메뉴에서 "초대하기"를 누른 뒤 친구의 이메일을 입력하면 바로 초대할 수 있어요. 친구와 함께 참여해 즐겁게 가계부를 작성해보세요! 🤝'
  }
]
