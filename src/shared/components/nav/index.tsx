...
function Nav() {
  ...
  return (
    <nav aria-label="하단 내비게이션" className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[420px] h-[60px] border-t border-t-neutral-light bg-white">
      <ul className='flex'>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                clsx(
                  ...
                  isActive ? "text-primary-base" : "text-neutral-dark hover:bg-neutral-100"
                )
              }
            >
